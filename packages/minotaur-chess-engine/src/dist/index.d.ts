...
declare function getRank(
  y: number,
  boardHeight: number,
  yOffset: number
): number;
declare function moveSlidingPiece(
  currentBitBoard: BitBoard,
  rankFrom: number,
  fileFrom: string,
  rankTo: number,
...
declare function applyMove(
  bitBoard: BitBoard,
  from: number,
  to: number,
  pieceBitBoard: keyof BitBoard
): BitBoard;
declare function clearPosition(
  bitBoard: BitBoard,
  position: number
): {
  whitePawn: bigint;
...
declare function isOccupiedComposite(
...
declare function getMoveFromBoardStates(
  before: BitBoard,
  after: BitBoard
): BitMove;
declare function getSinglePieceMoveFromBoardStates(
  before: BitBoard,
  after: BitBoard
): BitMove;
declare function getBeforeAndAfterPositions(
  before: bigint,
  after: bigint
): [number, number];
declare function getCastledMoveFromBoardStates(
  before: BitBoard,
  after: BitBoard
): BitMove;
...
declare function isAtoHwraparound(
  fromPosition: number,
  toPosition: number
): boolean;
declare function isABCtoFGHwraparound(
  fromPosition: number,
  toPosition: number
): boolean;
...
declare function isShortCastleRouteBlocked(
  board: BitBoard,
  isWhitesTurn: boolean
): boolean;
declare function isLongCastleRouteBlocked(
  board: BitBoard,
  isWhitesTurn: boolean
): boolean;
 ...
 */
declare function FindBestMoves(
  currentBoard: BitBoard,
  isWhitesTurn: boolean
): ScoreArray;
declare function FindBestMoveMiniMax(
  currentBoard: BitBoard,
  currentGameState: GameStatus,
  engineDepth: number
): BitMove;
declare function WhitePawnCaptures(
  boardState: BitBoard,
  allOccupiedBlackPositions: bigint
): BitMove[];
declare function WhitePawnMovesComposite(boardState: BitBoard): BitMove[];
declare function AllWhitePawnMovesOneSquare(
  boardState: BitBoard,
  allOccupiedPositions: bigint
): bigint;
declare function AllWhitePawnMovesTwoSquare(
  boardState: BitBoard,
  allOccupiedPositions: bigint
): bigint;
declare function AllWhitePawnCaptures(
  boardState: BitBoard,
  allOccupiedBlackPositions: bigint
): bigint;
declare function AllWhitePawnMovesComposite(boardState: BitBoard): BitBoard;
declare function BlackPawnMovesOneSquare(
  boardState: BitBoard,
  allOccupiedPositions: bigint
): BitMove[];
declare function BlackPawnCaptures(
  boardState: BitBoard,
  allOccupiedWhitePositions: bigint
): BitMove[];
declare function BlackPawnMovesComposite(boardState: BitBoard): BitMove[];
declare function AllBlackPawnMovesOneSquare(
  boardState: BitBoard,
  allOccupiedPositions: bigint
): bigint;
declare function AllBlackPawnMovesTwoSquare(
  boardState: BitBoard,
  allOccupiedPositions: bigint
): bigint;
declare function AllBlackPawnCaptures(
  boardState: BitBoard,
  allOccupiedWhitePositions: bigint
): bigint;
declare function AllBlackPawnMovesComposite(boardState: BitBoard): BitBoard;
declare function AllKnightMoves(
  boardState: BitBoard,
  allFriendlyOccupiedPositions: bigint,
  evaluateForWhite: boolean
): bigint;
declare function AllBishopMoves(
  boardState: BitBoard,
  allFriendlyOccupiedPositions: bigint,
  allEnemyOccupiedPositions: bigint,
  evaluateForWhite: boolean
): bigint;
declare function AllRookMoves(
  boardState: BitBoard,
  allFriendlyOccupiedPositions: bigint,
  allEnemyOccupiedPositions: bigint,
  evaluateForWhite: boolean
): bigint;
declare function AllKingMoves(
  boardState: BitBoard,
  allFriendlyOccupiedPositions: bigint,
  evaluateForWhite: boolean
): bigint;
declare function AllQueenMoves(
  boardState: BitBoard,
  allFriendlyOccupiedPositions: bigint,
  allEnemyOccupiedPositions: bigint,
  evaluateForWhite: boolean
): bigint;
declare function AllCompiledMoves(
  boardState: BitBoard,
  evaluateForWhite: boolean,
...
declare function evaluateBoard(
  currentBoard: BitBoard,
  evaluateForWhite: boolean
): number;
declare function evaluateMaterialAdvantages(
  currentBoard: BitBoard,
  evaluateForWhite: boolean
): number;
declare function evaluatePositionalAdvantages(
  currentBoard: BitBoard,
  evaluateForWhite: boolean
): number;
declare function evaluateCentralDominanceAdvantages(
  pieceBitBoard: bigint,
  evaluateForWhite: boolean,
  piece: keyof BitBoard
): number;
declare function evaluatePromotionalPossibilities(
  pawnBitBoard: bigint,
  evaluateForWhite: boolean
): number;
declare function evaluatePawnChains(
  pawnBitBoard: bigint,
  evaluateForWhite: boolean
): number;
declare function evaluatePieceDevelopment(
  currentBoard: BitBoard,
  evaluateForWhite: boolean
): number;
declare function evaluateFreedomToMove(
  currentBoard: BitBoard,
  evaluateForWhite: boolean
): number;
declare function evaluateKingSafety(
  currentBoard: BitBoard,
  evaluateForWhite: boolean
): number;
...
declare function maxMove(
  node: GameNode,
  depth: number,
  scoreForWhite: boolean,
  evalLogs: EvalLogs
): BitMove;
declare function scoredMove(
  score: number,
  previousBoardState: BitBoard,
  newBoardState: BitBoard
): BitMove;

declare function pushNewNode(
...
declare function kingCastlingNodes(
  node: GameNode,
  evalLogs: EvalLogs
): GameNode[];
...
declare function whitePawnCaptureNodes(
  node: GameNode,
  allOccupiedBlackPositions: bigint
): GameNode[];
declare function blackPawnNodes(node: GameNode): GameNode[];
declare function blackPawnTwoSquareNodes(
  node: GameNode,
  allOccupiedPositions: bigint
): GameNode[];
declare function blackPawnCaptureNodes(
  node: GameNode,
  allOccupiedWhitePositions: bigint
): GameNode[];
...
declare const outputSinglePiecePositions: (
  piecePositions: bigint,
  piece: keyof BitBoard,
  testName: string
) => void;
declare const outputSingleBitboardHtml: (
  currentBoard: BitBoard,
...
declare function MultiLog(
  outputType: LogLevels,
  message: string,
  outputVerbosity: LogLevels
): void;

declare function isLegalMove(
  moveAttempted: BoardMove,
  boardState: BitBoard,
  proposedBoardState: BitBoard
): LegalityResponse;
declare function isLegalQueenMove(
  moveAttempted: BoardMove,
  boardState: BitBoard,
  evaluateForWhite: boolean,
...
declare function isLegalKingMove(
  moveAttempted: BoardMove,
  boardState: BitBoard,
  evaluateForWhite: boolean,
  friendlyPositions: bigint,
...
declare function isLegalRookMove(
  moveAttempted: BoardMove,
  boardState: BitBoard,
  evaluateForWhite: boolean,
  friendlyPositions: bigint,
...
declare function isLegalBishopMove(
  moveAttempted: BoardMove,
  boardState: BitBoard,
  evaluateForWhite: boolean,
  friendlyPositions: bigint,
...
declare function isLegalKnightMove(
  moveAttempted: BoardMove,
  boardState: BitBoard,
  evaluateForWhite: boolean,
  friendlyPositions: bigint,
...
declare function isLegalPawnMove(
  moveAttempted: BoardMove,
  boardState: BitBoard
): boolean;
declare function isOnStartingRank(moveAttempted: BoardMove): boolean;
declare function isMyKingInCheck(
  currentBoard: BitBoard,
  evaluateForWhite: boolean
): CheckStatus;
declare function isOpponentChecked(
  currentBoard: BitBoard,
  evaluateForWhite: boolean
): CheckStatus;
