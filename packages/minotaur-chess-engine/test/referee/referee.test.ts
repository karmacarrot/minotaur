...
describe("isLegalMove", () => {
  it.each([
    ...
    [
      "whitePawn",
      "Forward two spaces from starting rank",
      null,
      "e",
      "e",
      2,
    ...
    [
      "whitePawn",
      "Illegal move, pawns cannot move backwards",
      null,
      "h",
      "h",
      3,
...
describe("isOpponentChecked", () => {
  it("returns true if the white queen moves onto an open file with the black king", () => {
    ...
    const opponentCheckedAfterQueenMove = isOpponentChecked(
    ...
    const opponentCheckedAfterSecondQueenMove = isOpponentChecked(
