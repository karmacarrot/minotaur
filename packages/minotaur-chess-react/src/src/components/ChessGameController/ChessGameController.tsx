...
import { getFile, getRank, Piece } from '@karmacarrot/minotaur-chess-engine';
import { BoardOffset } from '../ChessBoard/definitions';

export const ChessGameController: React.FC<ChessGameProps> = ({ config }) => {
