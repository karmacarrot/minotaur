...
export function GameControls({
  ...
  const [desiredArrangement, setDesiredArrangement] = useState(
    BoardArrangements.StartingPositions
  );
  ...
  const handleArrangementChange = (
    event: SelectChangeEvent<BoardArrangements>
  ) => {
    ...
    <GameControlsContainer>
      <Stack spacing={2} direction='row'>
        ...
        >
          ...
          <MenuItem value={BoardArrangements.DuellingPawns}>
            Duelling Pawns
          </MenuItem>
          <MenuItem value={BoardArrangements.MiniMaxOne}>MiniMax 1</MenuItem>
          <MenuItem value={BoardArrangements.MateInOneForBlackGameBoard}>
            Mate for black
          </MenuItem>
          <MenuItem value={BoardArrangements.MateInOneForWhiteGameBoard}>
            Mate for white
          </MenuItem>
          <MenuItem value={BoardArrangements.CastleForBlackGameBoard}>
            Castle for black
          </MenuItem>
          <MenuItem value={BoardArrangements.CastleForBlackAfter}>
            Castle for black after
          </MenuItem>
